			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						@endif
						<form class="form-horizontal" action="{{url('category/'.$field->cate_id)}}" method="post">
						...
						{{csrf_field()}}
							<div class="box-body">
    							...
    							<div class="form-group">
      								...
      								<div class="col-sm-10">
        								<input type="text" name="cate_name" class="form-control" value="{{$field->cate_name}}"><span><i style="color:red">*</i> 分类名称必须填写</span>
      								</div>
    							</div>
    							<div class="form-group">
      								<label class="col-sm-2 control-label"> 分类标题</label>
      								<div class="col-sm-10">
        								<input type="text" name="cate_title" class="form-control" value="{{$field->cate_title}}">
      								</div>
    							</div>
    							<div class="form-group">
      								<label class="col-sm-2 control-label"> 关键词</label>
      								<div class="col-sm-10">
        								<textarea class="form-control" name="cate_keywords" id="" rows="3">{{$field->cate_keywords}}</textarea>
      								</div>
    							</div>
    							<div class="form-group">
      								<label class="col-sm-2 control-label"> 描述</label>
      								<div class="col-sm-10">
        								<textarea class="form-control" name="cate_description" id="" rows="3">{{$field->cate_description}}</textarea>
      								</div>
    							</div>
    							<div class="form-group">
      								<label class="col-sm-2 control-label"><i style="color:red">*</i> 排序</label>
      								<div class="col-sm-10">
        								<input type="text" name="cate_order" class="form-control" value="{{$field->cate_order}}">
      								</div>
    							</div>
