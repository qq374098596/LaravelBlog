...
<link rel="stylesheet" type="text/css" href="{{asset('static/home/css/bootstrap.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('static/home/css/nprogress.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('static/home/css/style.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('static/home/css/font-awesome.min.css')}}">
<link rel="apple-touch-icon-precomposed" href="{{asset('static/home/images/icon.png')}}">
<link rel="shortcut icon" href="{{asset('static/home/images/favicon.ico')}}">
<script src="{{asset('static/home/js/jquery-2.1.4.min.js')}}"></script>
<script src="{{asset('static/home/js/nprogress.js')}}"></script>
<script src="{{asset('static/home/js/jquery.lazyload.min.js')}}"></script>
<!--[if gte IE 9]>
...
<div class="container">
  ...
  <div class="navbar-header">
	...
	<h1 class="logo hvr-bounce-in"><a href="#" title="木庄网络博客"><img src="{{asset('static/home/images/201610171329086541.png')}}" alt="木庄网络博客"></a></h1>
  </div>
...
<div class="content">
  <div id="focusslide" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
	  ...
	  <img src="{{asset('static/home/images//201610181557196870.jpg')}}" alt="木庄网络博客源码" class="img-responsive"></a>
	  </div>
	  <div class="item">
	  <a href="#" target="_blank" title="专业网站建设" >
	  <img src="{{asset('static/home/images//201610241227558789.jpg')}}" alt="专业网站建设" class="img-responsive"></a>
	  </div>
	</div>
  ...
  <a class="focus" href="#" title="用DTcms做一个独立博客网站（响应式模板）" target="_blank" ><img class="thumb" data-original="{{asset('static/home/images/201610181739277776.jpg')}}" src="images/201610181739277776.jpg" alt="用DTcms做一个独立博客网站（响应式模板）"  style="display: inline;"></a>
